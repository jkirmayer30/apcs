 ...
 * time spent: 0.4 hrs
 * DISCO: Heapsort runs in nlogn time
 * QCC: What are some good use cases for heapsort?
 * 2018-05-17
 */
...
public class Heapsort {
    ...
    public int[] sort(int[] data) {
        ...
        for (int lastLeaf = data.length-1; lastLeaf>0; lastLeaf--) {
            ...
            int pos = 0;
            int maxChildPos = maxChildPos(0,lastLeaf-1,data);
    ...
    private void minHeapify(int[] a) {
        ...
        for (int i = 1; i < a.length; i++) {
            ...
            while (a[addValPos] < a[parentPos] && addValPos > 0) { //potentially swap until reach root
